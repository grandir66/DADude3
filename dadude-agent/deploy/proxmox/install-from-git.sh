...
git clone --depth 1 --filter=blob:none --sparse https://github.com/grandir66/dadude.git dadude-temp 2>/dev/null || {
    # Fallback: clone completo
    git clone --depth 1 https://github.com/grandir66/dadude.git dadude-temp
}
